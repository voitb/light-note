...
export function NoteItem({ note, isActive, onSelectTag, userId, onDelete }: NoteItemProps) {
  ...
  return (
    <div className="group relative">
      ...
      >
        ...
        <p className="text-xs text-muted-foreground line-clamp-2 break-words max-h-10 overflow-hidden">{contentPreview}</p>
