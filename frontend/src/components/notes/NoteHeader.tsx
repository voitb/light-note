...
import { PanelLeftIcon, Plus, MoreVertical, Share, FileDown } from "lucide-react";
...
export function NoteHeader({ isMobile, toggleSidebar, onOpenShareDialog }: NoteHeaderProps) {
      ...
      <div className="flex items-center gap-4">
        ...
        {isMobile ? (
          <Sheet>
            ...
            <SheetContent side="left" className="p-0 w-80 max-w-[80vw] border-r">
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={onOpenShareDialog} disabled={!currentNote}>
